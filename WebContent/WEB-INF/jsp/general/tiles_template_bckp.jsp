...
<html>
	<head>
		...
		<link href="<c:url value="/resources/css/fsdffe.css"/>" rel="stylesheet" type="text/css" />
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  <tr>	  
	    <td height="121" align="left" valign="top" background="images/index_01.gif" style="background-repeat:repeat-x">	    
      ...
      <td height="133"  align="center" valign="top">
      	<div id="MainContainer"><!--MainContainer start-->
			<div id="InnerMainContainer"><!--InnerMainContainer start-->
	      	...
	      	<tr>
		        <td align="left" valign="top" background="images/index_07.gif" style="background-repeat:repeat-y">&nbsp;</td>
	        	<td width="80%" align="center" valign="top">
					<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <tr>
         			 ...
         			 <tr>         			
          			   <td background="images/index_24.gif" style="background-repeat:repeat-x" height="43px">
					...
					<td width="10%" align="left" valign="top" background="images/index_07.gif" style="background-repeat:repeat-y">&nbsp;</td>
				</tr>
   			</table>
