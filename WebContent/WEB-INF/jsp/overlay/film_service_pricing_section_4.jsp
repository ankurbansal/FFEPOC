<div id="film_service_pricing_section_4">
<table width="960" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
	<td class="section-big-subcol">	
		...
		<input type="hidden" id="countServicesSection-4" value="" />
		<input type="hidden" id="deletedServicesSection-4" value="" />		
	</td>
